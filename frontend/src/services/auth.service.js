...
class AuthService {
  ...
  deleteItemShop(itemname) {
    return axios.post(API_URL + "deleteItemShop",{itemname
  ...
  addShopping(itemname) {
    return axios.post(API_URL + "addShopping",{itemname
  ...
  getHistory(itemname) {
    return axios.post(API_URL + "getHistory",{itemname
